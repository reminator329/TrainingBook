...
async def execute(interaction: discord.Interaction, query: str):
    ...
    await response.send_message('Tic Tac Toe: X goes first', view=TicTacToe())


class CommandTicTacToe(command.Command):

    def __init__(self):
        super().__init__("tictactoe", "Play the game", execute)
